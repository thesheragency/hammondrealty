...
const analyzeDocument = (document, excludeOperationName)=>{
    ...
    const expression = typeof normalizedDocument === `string` ? normalizedDocument : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$language$2f$printer$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["print"])(normalizedDocument);
    let isMutation = false;
    let operationName = undefined;
...
const runRequest = async (input)=>{
    ...
    let result;
    try {
        result = await parseResultFromResponse(fetchResponse, input.fetchOptions.jsonSerializer ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$request$2f$build$2f$legacy$2f$helpers$2f$defaultJsonSerializer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["defaultJsonSerializer"]);
    } catch (error) {
...
//# sourceMappingURL=node_modules_7a7f57b0._.js.map