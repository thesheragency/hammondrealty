...
"[project]/app/sitemap_index.xml/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    let result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["proxyWordPressFile"])('/sitemap_index.xml', frontendUrl);
    if (!result) {
    ...
    if (!result) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Sitemap index not found', {
            status: 404,
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8cc2706f._.js.map